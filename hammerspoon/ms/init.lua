...
window_modal:bind({}, 'Q', "Quiet current window",        bind.set_window_rect({1/8, 8/14, 6/8, 5.5/14}))
...
music_modal:bind({}, 'S', 'Play/Pause', music.fn('playpause'))
music_modal:bind({}, 'A', 'Previous', music.fn('previous'), { shiftable = true })
music_modal:bind({}, 'D', 'Next', music.fn('next'),         { shiftable = true })
